...
const HeroSection = () => {
  ...
  return (
    ...
    className="relative h-screen bg-cover  bg-center border-b-4 border-gradient-to-r from-blue-500 to-purple-500"
      style={{ backgroundImage: 'url(/images/background11.jpg)' }}
    >
      <motion.div 
